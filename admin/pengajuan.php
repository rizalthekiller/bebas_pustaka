                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php foreach ($pengajuan as $p): ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo formatTanggalIndonesia($p['tanggal_pengajuan']); ?></td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <?php if ($p['status'] === 'Menunggu Verifikasi'): ?>
                                                            ...
                                                            <li><a class="dropdown-item text-success" href="#" onclick="approvePengajuan(<?php echo $p['id']; ?>)">
                                                                <i class="fas fa-check me-2"></i>Setujui & Buat Surat
                                                            </a></li>
                                                            <li><a class="dropdown-item text-danger" href="#" onclick="rejectPengajuan(<?php echo $p['id']; ?>)">
                                                                <i class="fas fa-times me-2"></i>Tolak
                                                            </a></li>
                                                        <?php elseif ($p['status'] === 'Disetujui'): ?>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li><a class="dropdown-item text-primary" href="surat.php?action=buat&id=<?php echo $p['id']; ?>">
                                                                <i class="fas fa-file-alt me-2"></i>Buat Surat
                                                            </a></li>
                                                        <?php endif; ?>
                                                    </ul>
                                                </div>
