...
$prodi = getProdiByFakultas(null); // Get all prodi with fakultas info

// Get prodi with fakultas names
$pdo = connectDB();
$stmt = $pdo->query("SELECT p.*, f.nama_fakultas FROM tb_prodi p LEFT JOIN tb_fakultas f ON p.id_fakultas = f.id ORDER BY f.nama_fakultas, p.nama_prodi");
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php else: ?>
                                                    <?php $no = 1; foreach ($prodi_with_fakultas as $p): ?>
                                                        <tr>
                                                            <td><?php echo $no++; ?></td>
